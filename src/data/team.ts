// Tokyo Loop is presented as the work of a small indie team — seven
...
export const TEAM: TeamMember[] = [
  ...
  { name: 'Yui Sakamoto', role: 'Arte y ambientación', note: 'Ha fotografiado los treinta andenes de la línea circular de Tokio en las cuatro estaciones del año.' },
