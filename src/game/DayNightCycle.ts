...
const KEYFRAMES: Keyframe[] = [
  { hour: 0, skyTop: C(0x03040d), skyBottom: C(0x0c1226), sunColor: C(0x33447a), sunIntensity: 0.05, ambientIntensity: 0.16, fogColor: C(0x05060f), fogNear: 60, fogFar: 900, label: 'Madrugada' },
  { hour: 3.5, skyTop: C(0x050714), skyBottom: C(0x121a35), sunColor: C(0x33447a), sunIntensity: 0.05, ambientIntensity: 0.17, fogColor: C(0x070a18), fogNear: 60, fogFar: 900, label: 'Madrugada' },
  { hour: 5, skyTop: C(0x142042), skyBottom: C(0x3a3560), sunColor: C(0x8a7bb8), sunIntensity: 0.25, ambientIntensity: 0.28, fogColor: C(0x241f3d), fogNear: 80, fogFar: 950, label: 'Alba' },
  { hour: 6, skyTop: C(0x2c3a6b), skyBottom: C(0xe08a5c), sunColor: C(0xffab6b), sunIntensity: 0.9, ambientIntensity: 0.42, fogColor: C(0xe08a5c), fogNear: 100, fogFar: 1100, label: 'Amanecer' },
  { hour: 7.5, skyTop: C(0x5f8ad0), skyBottom: C(0xffd9a0), sunColor: C(0xffdcb0), sunIntensity: 1.4, ambientIntensity: 0.55, fogColor: C(0xcfe0f0), fogNear: 150, fogFar: 1300, label: 'Mañana' },
  ...
  { hour: 19.5, skyTop: C(0x141235), skyBottom: C(0x5a3a5e), sunColor: C(0x9a5aa0), sunIntensity: 0.3, ambientIntensity: 0.28, fogColor: C(0x281f3d), fogNear: 70, fogFar: 950, label: 'Noche cerrada' },
  { hour: 21, skyTop: C(0x05071a), skyBottom: C(0x161c3a), sunColor: C(0x33447a), sunIntensity: 0.08, ambientIntensity: 0.2, fogColor: C(0x0a0d1e), fogNear: 60, fogFar: 900, label: 'Noche' },
  { hour: 24, skyTop: C(0x03040d), skyBottom: C(0x0c1226), sunColor: C(0x33447a), sunIntensity: 0.05, ambientIntensity: 0.16, fogColor: C(0x05060f), fogNear: 60, fogFar: 900, label: 'Madrugada' },
]
...
export class DayNightCycle {
  ...
  constructor(scene: THREE.Scene) {
    ...
    this.sunSprite = new THREE.Sprite(
      new THREE.SpriteMaterial({ color: 0xfff2c0, transparent: true, depthWrite: false, fog: false }),
    )
    this.sunSprite.scale.setScalar(140)
    scene.add(this.sunSprite)

    this.moonSprite = new THREE.Sprite(
      new THREE.SpriteMaterial({ color: 0xdfe6ff, transparent: true, opacity: 0.9, depthWrite: false, fog: false }),
    )
    this.moonSprite.scale.setScalar(90)
  ...
  get phaseLabel(): string {
    return lerpKeyframes(this.timeOfDay).label
  }
  ...
  update(dt: number, focusPoint = new THREE.Vector3()) {
    ...
    this.ambient.groundColor.set(0x1a1410)
